...
parser.add_argument('--dropoutatt', type=float, default=0.5,
                    help='dropout to remove probability from attention layer (0 = no dropout)')
...
if args.continue_train:
    ...
    model = model.RNNModelSearch(ntokens, args.emsize, args.nhid, args.nhidlast, 
                       args.dropout, args.dropouth, args.dropoutx, args.dropouti, args.dropoute, args.dropoutatt)
...
def train():
    ...
    while i < train_data.size(0) - 1 - 1:
        ...
        if batch % args.log_interval == 0 and batch > 0:
            ...
            print(F.softmax(parallel_model.weights_att, dim=-1))
