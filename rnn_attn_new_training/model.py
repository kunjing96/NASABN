...
class DARTSCell(nn.Module):
  ...
  def forward(self, inputs, hidden, arch_mask):
    ...
    hiddens = []
    for t in range(T):
      hidden = self.cell(inputs[t], hidden, x_mask, h_mask, arch_mask)
...
class RNNModel(nn.Module):
    ...
    def forward(self, input, hidden, return_h=False, arch_mask=False):
        ...
        for l, rnn in enumerate(self.rnns):
            ...
            raw_output, new_h = rnn(raw_output, hidden[l], arch_mask=arch_mask)
